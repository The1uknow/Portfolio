...
const ProjectCard = ({ project }: { project: Project }) => {
  return (
    <div className="group bg-card border border-border-subtle rounded-lg overflow-hidden hover:border-accent-green-muted transition-all duration-300 hover:shadow-glow">
      {/* Project Image */}
